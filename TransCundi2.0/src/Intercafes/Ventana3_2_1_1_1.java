...
public class Ventana3_2_1_1_1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ventana3_2_1_1_1 frame = new Ventana3_2_1_1_1();
	...
	public Ventana3_2_1_1_1() {
		...
		JLabel lblNewLabel_1_1 = new JLabel("Pasajeros que suben");
		lblNewLabel_1_1.setFont(new Font("Trebuchet MS", Font.BOLD, 26));
		lblNewLabel_1_1.setBounds(189, 218, 254, 53);
		...
		JLabel lblNewLabel_1 = new JLabel("Pasajeros que bajan sel vehiculo");
		lblNewLabel_1.setFont(new Font("Trebuchet MS", Font.BOLD, 26));
		lblNewLabel_1.setBounds(115, 74, 403, 53);
